...
# from .generators import generate_client_id
...
#         max_length=120, unique=True, default=generate_client_id, db_index=True
#     )
#     client_secret = models.CharField(
#         max_length=120, unique=True, default=generate_client_id, db_index=True
#     )
#     application_name = models.CharField(max_length=120)
